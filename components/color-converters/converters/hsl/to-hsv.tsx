...
export default function HslHsvConverter() {
  const { toast } = useToast();
  const { colorHistory } = useColorHistoryContext();

  const [hsl, setHsl] = useState({ h: 345, s: 52, l: 51 });
  ...
  return (
    <Wrapper size="lg">
      <Container>
        <p>
          Easily transform your HSL values into HSV values! Enter your HSL values below and get
