      ...
      <Wrapper>
        <Container as="section" className="prose pb-12 dark:prose-invert md:pb-24">
          ...
          <ul>
            ...
            <li>
              <strong>High Desktop/Laptop Usage</strong>: 93% of traffic comes from desktop or
              laptop, perfect for B2B and design-focused brands.
            </li>
          </ul>
          ...
          <p>
            First come, first served! Each slot gets premium placement and rotates in order of
            value. Non-intrusive, visually prominent, and seen by every visitor.
          </p>
          ...
          <p>
            Reserve your slot below. Sponsorship is billed monthly, cancel anytime. Premium slots
            move fastest!
          </p>
