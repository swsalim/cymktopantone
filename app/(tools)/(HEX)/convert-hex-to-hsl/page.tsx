...
import HexHslContent from '@/components/hex-hsl-content';
import HexHslConverter from '@/components/hex-hsl-converter';
...
export default function HexHslPage() {
  return (
    <>
      <WebsiteJsonLd company={siteConfig.siteName} url={absoluteUrl('/convert-hex-to-hsl')} />
