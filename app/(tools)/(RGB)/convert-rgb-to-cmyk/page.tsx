...
import RgbCmykContent from '@/components/rgb-cmyk-content';
import RgbCmykConverter from '@/components/rgb-cmyk-converter';
...
export default function RgbCmykPage() {
  return (
    <>
      <WebsiteJsonLd company={siteConfig.siteName} url={absoluteUrl('/convert-rgb-to-cmyk')} />
