...
import RgbHslContent from '@/components/rgb-hsl-content';
import RgbHslConverter from '@/components/rgb-hsl-converter';
...
export default function RgbHslPage() {
  return (
    <>
      <WebsiteJsonLd company={siteConfig.siteName} url={absoluteUrl('/convert-rgb-to-hsl')} />
