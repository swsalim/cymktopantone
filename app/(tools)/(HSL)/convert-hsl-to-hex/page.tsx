...
import HslHexContent from '@/components/hsl-hex-content';
import HslHexConverter from '@/components/hsl-hex-converter';
...
export default function HslHexPage() {
  return (
    <>
      <WebsiteJsonLd company={siteConfig.siteName} url={absoluteUrl('/convert-hsl-to-hex')} />
