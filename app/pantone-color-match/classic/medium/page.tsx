...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/pantone-color-match/classic/medium',
  },
  openGraph: {
    title: 'Classic Medium Mode - Pantone Color Match',
    description: `Balance challenge and fun with ${GAME_DIFFICULTY.medium.pairsCount} Pantone color pairs. Test your memory at a comfortable pace.`,
    url: '/pantone-color-match/classic/medium',
    images: [
      {
        url: new URL(
...
const JSONLDbreadcrumbs = [
  ...
  {
    url: absoluteUrl('/pantone-color-match/classic'),
    name: 'Classic Mode',
  },
  {
    url: absoluteUrl('/pantone-color-match/classic/medium'),
    name: 'Medium Mode',
  },
];
...
export default function PantoneMatchMediumPage() {
  return (
    <>
      ...
      <WebPageJsonLd
        id={absoluteUrl('/pantone-color-match/classic/medium')}
        description={`Balance challenge and fun with ${GAME_DIFFICULTY.medium.pairsCount} Pantone color pairs. Test your memory at a comfortable pace.`}
      />
